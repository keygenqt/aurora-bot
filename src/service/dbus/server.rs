...
impl ServerDbus {
    ...
    pub fn new() -> ServerDbus {
        ...
        let signal_state = cr.register(constants::DBUS_NAME, |builder| {
            ...
            EmulatorOpenVncIncoming::dbus_method_run(builder);
            EmulatorOpenVncIncoming::dbus_method_run_by_id(builder);
            EmulatorRecordDisableIncoming::dbus_method_run(builder);
            EmulatorRecordDisableIncoming::dbus_method_run_by_id(builder);
            EmulatorRecordEnableIncoming::dbus_method_run(builder);
            EmulatorRecordEnableIncoming::dbus_method_run_by_id(builder);
