    ...
    pub fn gen_report_pdf(
        ...
        doc.push(
            elements::Paragraph::default()
                ...
                .string(". Пакеты разделены на платформа зависимые и платформа не зависимые (плагины). Такой отчет упрощает процесс портирование приложения Flutter под платформу ОС Аврора.")
        );
        doc.push(elements::Break::new(1.5));
